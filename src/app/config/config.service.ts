...
export class ConfigService {
  ...
  PostDoner(hero: any): Observable<any> {
    return this.http
      .post<any>(`${this.configUrl}/members/addDonor`, hero, httpOptions)
      .pipe(catchError(this.handleError));
  }
  PostVolunteer(hero: any): Observable<any> {
    return this.http
      .post<any>(`${this.configUrl}/members/addVolunteer`, hero, httpOptions)
      .pipe(catchError(this.handleError));
  }
  subscribe(hero: any): Observable<any> {
    return this.http
      .post<any>(`${this.configUrl}/subscribe`, hero, httpOptions)
      .pipe(catchError(this.handleError));
  }

  contactUS(hero: any): Observable<any> {
    return this.http
      .post<any>(`${this.configUrl}/contact/`, hero, httpOptions)
      .pipe(catchError(this.handleError));
  }
